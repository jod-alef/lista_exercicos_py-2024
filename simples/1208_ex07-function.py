...
def calculoLitros(comprimentoPista, numeroVoltas, consumoVeiculo, numeroAbastecimento):
    return (((comprimentoPista / 1000) * numeroVoltas)/consumoVeiculo)/numeroAbastecimento

print("Numero mínimo de litros necessário para percorrer até abastecimento", calculoLitros(comprimentoPista,numeroVoltas,numeroAbastecimento,consumoVeiculo))